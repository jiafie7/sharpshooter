...
from game.views.settings.acwing.acapp.apply_code import \
    apply_code as acapp_apply_code
from game.views.settings.acwing.acapp.receive_code import \
    receive_code as acapp_receive_code
from game.views.settings.acwing.web.apply_code import \
    apply_code as web_apply_code
from game.views.settings.acwing.web.receive_code import \
    receive_code as web_receive_code
